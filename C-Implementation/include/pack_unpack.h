 ...
 * representations and packed byte strings, for each of the moduli
 * used in Saber (Zq, Zp, Zt, Z2). These functions define this
 * implementation's byte-level wire format for public keys, secret
