 ...
 *   - gen_matrix:       generates the public matrix A from a seed (Algorithm 15)
 *   - gen_secret:       samples a secret vector from a noise seed (Algorithm 16)
 *   - matrix_vector_mul: multiplies a matrix by a vector in R_q (Algorithm 13)
 *   - inner_prod:       computes the inner product of two vectors in R_p
 * (Algorithm 14)
 *
